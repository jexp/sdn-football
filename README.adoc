...
== Update: Football/Soccer Demo

The rest of this guide is a copy of the original spring.io guide for getting started with Spring-Boot, SDN and SD-REST.

I changed the domain to football and created these entities:
...
A simplistic dataset is created in the DatabasePopulator.

image::https://dl.dropboxusercontent.com/u/14493611/football_domain_sdn.png[]
